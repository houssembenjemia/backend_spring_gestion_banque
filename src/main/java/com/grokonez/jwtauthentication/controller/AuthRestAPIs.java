	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpForm signUpRequest) {
		...
		strRoles.forEach(role -> {
			...
			case "admin":
				...
				break;
			case "Createur":
				Role CreateurRole = roleRepository.findByName(RoleName.ROLE_Createur)
						.orElseThrow(() -> new RuntimeException("Fail! -> Cause: User Role not find."));
				roles.add(CreateurRole);

				break;
			case "VALIDEUR":
				Role VALIDEURRole = roleRepository.findByName(RoleName.ROLE_VALIDEUR)
						.orElseThrow(() -> new RuntimeException("Fail! -> Cause: User Role not find."));
				roles.add(VALIDEURRole);
